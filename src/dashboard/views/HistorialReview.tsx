...
import type { RevisionHistoryItem, ComparisonResult } from '@/dashboard/types';
import { DeleteIcon, ChevronDownIcon } from '@/dashboard/components/Icons';
import { compareRevisions } from '@/dashboard/utils/comparisonUtils';
        ...
        <>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
                <div className="flex justify-end mb-4">
                    <button onClick={handleCompare} disabled={!canCompare} className="bg-[#1e293b] text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-[#1e293b]/90 transition-colors disabled:bg-slate-300 disabled:cursor-not-allowed">
