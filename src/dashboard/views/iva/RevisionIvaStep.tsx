...
import type { IvaRevisionResult, DocumentoDiscrepancia, AuxiliarData, DianData, VentasComprasData, DocumentoDiscrepanciaClasificacion } from '@/dashboard/types';
import { CheckCircleIcon, ChevronDownIcon } from '@/dashboard/components/Icons';
