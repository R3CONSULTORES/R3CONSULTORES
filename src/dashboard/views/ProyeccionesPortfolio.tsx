...
import { TrendingUpIcon, BoltIcon, CheckCircleIcon, SearchIcon, XMarkIcon } from '@/dashboard/components/Icons';
            ...
            <div className="p-5 flex-grow">
                <div className="mb-6">
                    ...
                    <div className="w-full bg-slate-100 rounded-full h-2 overflow-hidden">
                        <div 
                            className={`h-2 rounded-full transition-all duration-1000 ${isOverLimit ? 'bg-red-500' : 'bg-[#1e293b]'}`} 
        ...
        <div className="animate-fadeIn p-4 md:p-8">
            <header className="mb-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-6">
                    <div>
                        <h1 className="text-3xl font-bold text-[#1e293b]">Portafolio de Proyecciones</h1>
            ...
            {groupedData.size === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl border-2 border-dashed border-slate-200 text-center">
                    ...
                    <button 
                        ...
                        className="mt-6 bg-[#1e293b] text-white font-bold py-2 px-6 rounded-lg shadow-lg hover:bg-slate-800 transition-colors"
                    >
