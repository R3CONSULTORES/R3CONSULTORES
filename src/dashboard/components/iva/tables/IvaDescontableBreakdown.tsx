        ...
        return (
            <React.Fragment key={key}>
                <tr className={`border-b border-slate-100 transition-colors ${isExpanded ? 'bg-slate-50' : 'hover:bg-slate-50'}`}>
                    ...
                    <td className="p-4 text-right font-mono font-bold text-[#1e293b]">{formatCurrency(total)}</td>
                </tr>
                {isExpanded && (
                    <tr>
            ...
            <table className="min-w-full text-sm">
                ...
                <tbody>
                    ...
                    <tr className="bg-slate-50 font-bold text-slate-800 border-t border-slate-200">
                        ...
                        <td className="p-4 text-right font-mono text-[#1e293b]">{formatCurrency(granTotal)}</td>
                    </tr>
                </tbody>
            </table>
        </div>
