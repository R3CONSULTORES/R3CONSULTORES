...
import { LiquidationSection } from '@/dashboard/components/iva/components/LiquidationSection';
import { ProrrateoSummary } from '@/dashboard/components/iva/components/ProrrateoSummary';
            ...
            {ivaLiquidationResult ? (
                ...
                <div className="bg-white p-16 rounded-xl shadow-md text-center border-2 border-dashed border-gray-200">
                    ...
                    {onOpenFiles && (
                        <button 
                            onClick={onOpenFiles}
                            className="bg-[#1e293b] text-white font-bold py-3 px-6 rounded-xl shadow-lg hover:bg-slate-800 transition-all transform hover:scale-105 flex items-center gap-2 mx-auto"
                        >
