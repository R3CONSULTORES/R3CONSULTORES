...
import type { ComparisonResult, AnyFinding, Diferencia, RetencionFinding, CoherenciaFinding, DocumentoDiscrepancia, DocumentoDiscrepanciaClasificacion } from '@/dashboard/types';
