...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#111827] text-white/60 py-8 lg:py-12 border-t border-white/5 relative z-10 w-full mt-10">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4 text-xs items-center">
            ...
            <Link href="https://app.r3consultores.com/" className="text-white/20 hover:text-white transition-all ml-4 group" title="Acceso Software Clientes">
                <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/></svg>
            </Link>
          </div>
        </div>
      </div>
