...
import type { AppState, Diferencia, RetencionFinding, AnalisisCuenta, ValidationResult, GroupedDiscrepancy, DocumentoDiscrepancia, DocumentoDiscrepanciaClasificacion, CoherenciaFinding } from '../types';
