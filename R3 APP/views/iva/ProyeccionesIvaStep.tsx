...
import type { SavedProyeccion, MonthlySnapshot } from '../../types';
import { BoltIcon, CheckCircleIcon, ClockIcon, LockClosedIcon, XMarkIcon, ChevronDownIcon } from '../../components/Icons';
        ...
        <div className="space-y-8 pb-20 animate-fadeIn">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                <div className="flex justify-between items-start mb-6">
                    <div>
                        <h2 className="text-2xl font-bold text-[#000040]">Gestor de Historial Tributario</h2>
