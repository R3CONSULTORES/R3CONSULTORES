...
import type { AnalisisCuenta, Diferencia, ResumenDiferencias, DianData, VentasComprasData, DocumentoDetalle, RetencionFinding, TipoHallazgo, ValidationResult, IvaRevisionResult, DocumentoDiscrepancia, DocumentoDiscrepanciaClasificacion, GroupedDiscrepancy, CoherenciaFinding, AuxiliarData } from '../types';
import { ChevronDownIcon, CheckCircleIcon, ExclamationCircleIcon, ArchiveBoxIcon, BoltIcon } from '../components/Icons';
import { findRuleForTransaction, RETENTION_ACCOUNT_CONCEPTS } from '../utils/retencionesData';
import { generatePdfReport, generateZipArchive } from '../utils/reportGenerator';
                ...
                <div className="flex flex-col md:flex-row flex-wrap items-start justify-between gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto self-start md:self-end">
                         <button
                            ...
                            className="w-full md:w-auto bg-blue-600 text-white font-bold py-2 px-5 rounded-lg shadow-md hover:bg-blue-700 transition-colors duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
