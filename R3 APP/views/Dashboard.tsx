                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <button 
                            ...
                            className="w-full bg-[#000040] hover:bg-[#000030] text-white p-4 rounded-xl shadow-md transition-all transform active:scale-[0.98] flex items-center gap-4 group"
                        >
                            ...
                            <div className="text-left">
                                ...
                                <span className="text-xs text-blue-200 opacity-80">Auditoría Contable & Fiscal</span>
                            </div>
                        </button>
