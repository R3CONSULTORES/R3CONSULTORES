...
import { ProrrateoKPIs } from '../components/ProrrateoKPIs';
...
export const ProrrateoView: React.FC<ProrrateoViewProps> = ({
    ...
    return (
        <div className="space-y-8 pb-12">
            {/* Header */}
            <div>
                <h2 className="text-2xl font-bold text-[#000040]">Análisis de Prorrateo y Devoluciones</h2>
                    ...
                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 border-b border-gray-100 pb-4">
                        <div className="max-w-md">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h3 className="font-bold text-[#000040] text-sm uppercase tracking-wide">Configuración de Cálculo</h3>
                            </div>
